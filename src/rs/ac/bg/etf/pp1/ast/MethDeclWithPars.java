...
public class MethDeclWithPars extends MethodDecl {
    ...
    public MethDeclWithPars (MethodTypeAndName MethodTypeAndName, FormPars FormPars, VarDeclList VarDeclList, StatementList StatementList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethDeclWithPars(\n");
