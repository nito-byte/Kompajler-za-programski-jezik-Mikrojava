...
public class DesignatorStatement_Func extends DesignatorStatement {

    private Designator Designator;
    private DesignStmActPars DesignStmActPars;

    public DesignatorStatement_Func (Designator Designator, DesignStmActPars DesignStmActPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatement_Func(\n");
