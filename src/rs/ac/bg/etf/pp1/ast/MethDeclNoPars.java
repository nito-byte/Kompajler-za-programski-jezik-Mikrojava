...
public class MethDeclNoPars extends MethodDecl {

    private MethodTypeAndName MethodTypeAndName;
    private VarDeclList VarDeclList;
    private StatementList StatementList;

    public MethDeclNoPars (MethodTypeAndName MethodTypeAndName, VarDeclList VarDeclList, StatementList StatementList) {
