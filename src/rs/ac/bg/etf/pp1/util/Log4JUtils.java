...
//		File errFile = new File("test/izlaz.err");
//		//File errRenamedFile = new File(logFile.getAbsoluteFile()+"."+System.currentTimeMillis());
//		File errRenamedFile = new File("test/izlaz.err"+System.currentTimeMillis());
//		
//		if (errFile.exists()) {
//			if (!logFile.renameTo(errRenamedFile))
//				System.err.println("Could not rename log file!");
//		}
//		
//		fAppender.setFile(errFile.getAbsolutePath());
//		fAppender.activateOptions();
